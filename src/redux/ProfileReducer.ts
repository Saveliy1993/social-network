...
type ActionsType = AddPostActionCreatorActionType | UpdateNewPostTextActionCreatorActionType
...
export const saveProfile = (profile: ProfileType): ThunkType => async (dispatch, getState: any) => { // getstate??
